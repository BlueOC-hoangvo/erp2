  ...
  try {
    ...
    const products = await Promise.all([
      prisma.product.create({
        data: {
          ...
          sku: 'DELL-INS-15-001',
          description: 'Laptop Dell Inspiron 15 3000 Series - CPU Intel i5, RAM 8GB, SSD 256GB',
          unit: 'cái',
          costPrice: 12000000,
          salePrice: 15000000,
          category: 'Laptop',
      ...
      prisma.product.create({
        data: {
          ...
          sku: 'SAM-MON-24-001',
          description: 'Màn hình Samsung 24" Full HD IPS',
          unit: 'cái',
          costPrice: 2500000,
          salePrice: 3200000,
          category: 'Monitor',
      ...
      prisma.product.create({
        data: {
          ...
          sku: 'KEY-KB-M-001',
          description: 'Bàn phím cơ Keychron K6 - Switch Brown',
          unit: 'cái',
          costPrice: 1200000,
          salePrice: 1800000,
          category: 'Accessories',
    ...
    const order1 = await prisma.salesOrder.create({
      data: {
        ...
        total: 16000000,
        status: 'confirmed',
        notes: 'Đơn hàng khách hàng VIP - giao hàng trong 3 ngày',
    ...
    const order3 = await prisma.salesOrder.create({
      data: {
        ...
        total: 8150000,
        status: 'shipped',
        notes: 'Đơn hàng combo - đã đóng gói cẩn thận',
